...
public class OutputProcessorTest {
    ...
    public void map() throws IOException {
        ...
        final OutputProcessorConfiguration configuration =  new OutputProcessorConfiguration()
                                                                                /* .setAction()
                                                                                   .setUsername()
                                                                                   .setAccessKey()
                                                                                   .setModule()
        ...
        final Processor processor = COMPONENT_FACTORY.createProcessor(OutputProcessor.class, configuration);
